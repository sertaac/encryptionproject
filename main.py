...
import multiprocessing # Add this import for num_cpu_cores

from detector import PasswordProtectionDetector

async def main(): # Change to async def
    """
    ...
    # You can adjust max_workers based on your system and expected workload
